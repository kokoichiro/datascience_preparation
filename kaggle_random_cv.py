...
class kaggleexploration():
	...
	def set_parameters(self,
		...
		record_txt=None,
		id=None):
		with open(yml_loc,'r') as ymlfile:
		...
		self.training_rate=cfg['ML_parameter']['target_rate']
...
if __name__ == "__main__":
	...
	parser.add_argument('--mode',required=False,help = 'You can select one variable from 3 parameters you can skip this parameter.',default='all',choices=['all','random_search','training'])
	...
	df_answer.to_csv(exp.submission_file)