...
if __name__ == "__main__":
	...
	if random_search_cat.best_score_ >= random_search_cat.best_score_ and random_search_cat.best_score_ >= random_search_lgb.best_score_:
		random_search=random_search_cat
	elif random_search_cat.best_score_ >= random_search_cat.best_score_ and random_search_cat.best_score_ >= random_search_lgb.best_score_:
		random_search=random_search_cat
	elif random_search_lgb.best_score_ >= random_search_cat.best_score_ and random_search_lgb.best_score_ >= random_search_cat.best_score_:
