...
if __name__ == "__main__":
	...
	train_labels1=train_labels1.drop(xgbexp.target_name,axis=1)
        params = {'learning_rate': [0.01,0.02,0.3,0.5],'min_child_weight': [1, 5, 10],'gamma': [0.5, 1, 1.5, 2, 5],'subsample': [0.6, 0.8, 1.0],'colsample_bytree': [0.6, 0.8, 1.0],'max_depth': [3, 4, 5,10]}
